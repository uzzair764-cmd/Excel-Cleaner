...
def get_age_group(value, age_groups):
    ...
    # --------------------------------------------------------
    # First five groups must be ranges such as:
    # 18-21
    # 22-30
    # 31-40
    # 41-50
...
def write_summary_sheet(
    ...
    # Easier and safer: locate the age section
    age_columns = []
